...
To recover magnetic direction and moment we only need to assume that for each data window there is one source with it's central positions known (so we apply Euler deconvolution) and the magnetization is uniform.
