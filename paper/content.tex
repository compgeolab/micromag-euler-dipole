...
The Python source code used to produce all results and figures presented here, as well as supplemental figures and Jupyter notebooks, are available from \citet{sourcearchive}\footnote{Also avaliable on GitHub: \url{https://github.com/\GitHubRepository}} under the MIT and CC-BY licenses.
