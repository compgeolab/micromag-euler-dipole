...
% * information.tex: Title, journal, DOIs, dates.
...
\newcommand{\Authors}{%
  ...
  Janine Carmo\textsuperscript{1},
  and
  Roger Fu\textsuperscript{3}
}
\newcommand{\EmailGSJ}{gelson.ferreira@iag.usp.br}
\newcommand{\Corresponding}{%
  Corresponding author: Gelson Ferreira Souza Junior <\href{mailto:\EmailGSJ}{\EmailGSJ}>
}
\newcommand{\Affiliations}{%
  \textsuperscript{1} Universidade de São Paulo, Brazil;
  \textsuperscript{2} University of Liverpool, UK;
  \textsuperscript{3} Harvard University, USA
}
...
\begin{FlushLeft}
  ...
  \newline
  {\footnotesize Received in original form on \SubmittedOn.}
\end{FlushLeft}
